  ...
  return (
    <div
      className='[&_a]:text-primary [&_code]:bg-muted [&_pre]:bg-muted
        [&_td]:border-border [&_th]:border-border space-y-1.5 text-[11px]
        leading-snug break-words [&_a]:underline [&_code]:rounded [&_code]:px-1
        [&_code]:py-0.5 [&_code]:font-mono [&_code]:text-[10px]
        [&_h1]:text-[13px] [&_h1]:font-semibold [&_h2]:text-[12px]
