...
export function SecretsManager({ workspaceName }: SecretsManagerProps) {
  const secrets = useQuery(api.secrets.list, { workspaceName });
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    setSaving(true);
    try {
      await setSecret({ workspaceName, name, value });
      setName(null);
      setValue('');
  ...
  async function handleRemove(secretName: string) {
    ...
    try {
      await removeSecret({ workspaceName, name: secretName });
