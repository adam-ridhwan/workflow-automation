    ...
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Popup
        ...
        className={cn(
          ...
          -translate-x-1/2 -translate-y-1/2 gap-4 rounded-xl p-4 ring-1
          duration-100 outline-none data-[size=default]:max-w-xs
  ...
  return (
    <div
      ...
      className={cn(
        ...
        border-t p-4 group-data-[size=sm]/alert-dialog-content:grid
...
function AlertDialogMedia({
  ...
  return (
    <div
      ...
      className={cn(
        `bg-muted mb-2 inline-flex size-10 items-center justify-center
