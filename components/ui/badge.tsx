  ...
  [&>svg]:size-3!`,
  {
    variants: {
      variant: {
        ...
        running:
          'bg-[#D8E3F7] text-blue-600 dark:bg-[#181F2C] dark:text-blue-400',
        success: `bg-[#D6ECE2] text-emerald-600 dark:bg-[#11271B]
        dark:text-emerald-400`,
        error: 'bg-[#F7D9D9] text-red-600 dark:bg-[#301714] dark:text-red-400',
      },
    },
    defaultVariants: {
      variant: 'default',
